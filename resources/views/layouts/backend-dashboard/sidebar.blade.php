...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="dashboard" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Thesis Project</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a id="imports" href="/imports" class="nav-link">
        ...
        <li class="nav-item">
          <a id="pages" href="" class="nav-link">
